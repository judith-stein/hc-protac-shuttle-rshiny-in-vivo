...
BuildModelForN <- function(max = 1) {
  ...
  Ab_C1_b1KD <- ifelse(max >= 2, 
                       paste0("- K_Ab_Drug_on  * Ab_C1_b1 * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b2
                              - K_Ab_Meta_on * (max - 1) * Ab_C1_b1 * Meta1_C1_f
                              + K_Ab_Meta_off * Ab_C1_b1_m1"), 
                       paste0(""))
  
  Ab_C2_b1KD <- ifelse(max >= 2, 
                       paste0("- K_Ab_Drug_on  * Ab_C2_b1 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b2"), 
                       paste0(""))
  
  Ab_C2_m1KD <- ifelse(max >= 2, 
                       paste0("- K_Ab_Drug_on  * Ab_C2_m1 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b1_m1"), 
                       paste0(""))
  
  Ab_C1_b2KD <- ifelse(max > 2, 
                       paste0("- K_Ab_Drug_on  * Ab_C1_b2 * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b3
...
d/dt(Ab_C1_b2) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b2 
                  ...
                  + K_Ab_Drug_on  * Ab_C1_b1 * Drug_C1_f
                  - K_Ab_Drug_off * Ab_C1_b2
                  ", Ab_C1_b2KD), 
paste0(""))
  
  Ab_C1_b3KD <- ifelse(max > 3, 
                       paste0(" - K_Ab_Drug_on  * Ab_C1_b3 * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b4
...
d/dt(Ab_C1_b3) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b3 
                  ...
                  + K_Ab_Drug_on  * Ab_C1_b2 * Drug_C1_f
                  - K_Ab_Drug_off * Ab_C1_b3
                  ", Ab_C1_b3KD), 
paste0(""))
  
  Ab_C1_m1KD <- ifelse(max > 1, 
                       paste0(" - K_Ab_Drug_on  * Ab_C1_m1 * Drug_C1_f
  ...
  Ab_C1_m2KD <- ifelse(max > 2, 
                       paste0(" - K_Ab_Drug_on  * Ab_C1_m2 * Drug_C1_f
...
paste0(""))
  ...
  Ab_C1_m3KD <- ifelse(max > 3, 
                       paste0(" - K_Ab_Drug_on  * Ab_C1_m3 * Drug_C1_f
...
paste0(""))
  ...
  Ab_C1_b1_m1KD <- ifelse(max > 2, 
                          paste0(" - K_Ab_Drug_on  * Ab_C1_b1_m1 * Drug_C1_f
...
d/dt(Ab_C1_b1_m1) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b1_m1
                      ...
                      + K_Ab_Meta_on * (max - 1) * Ab_C1_b1 * Meta1_C1_f
                      - K_Ab_Meta_off * Ab_C1_b1_m1
                      + K_Ab_Drug_on* Ab_C1_m1 * Drug_C1_f
                      - K_Ab_Drug_off * Ab_C1_b1_m1
                      ", Ab_C1_b1_m1KD), 
paste0(""))
  
  Ab_C1_b1_m2KD <- ifelse(max > 3, 
                          paste0(" - K_Ab_Drug_on  * Ab_C1_b1_m2 * Drug_C1_f
...
d/dt(Ab_C1_b1_m2) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b1_m2
                    ...
                    + K_Ab_Meta_on * (max - 2) * Ab_C1_b1_m1 * Meta1_C1_f
                    - K_Ab_Meta_off * Ab_C1_b1_m2
                    + K_Ab_Drug_on  * Ab_C1_m2 * Drug_C1_f
                    - K_Ab_Drug_off * Ab_C1_b1_m2
                    ", Ab_C1_b1_m2KD), 
paste0(""))
  
  Ab_C1_b2_m1KD <- ifelse(max > 3, 
                          paste0(" - K_Ab_Drug_on * Ab_C1_b2_m1 * Drug_C1_f
...
d/dt(Ab_C1_b2_m1) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b2_m1
                      ...
                      + K_Ab_Meta_on * (max - 2) * Ab_C1_b2 * Meta1_C1_f
                      - K_Ab_Meta_off * Ab_C1_b2_m1
                      + K_Ab_Drug_on  * Ab_C1_b1_m1 * Drug_C1_f
                      - K_Ab_Drug_off * Ab_C1_b2_m1
                      ", Ab_C1_b2_m1KD), 
paste0(""))
...
d/dt(Ab_C1_b1_m3) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b1_m3
                      ...
                      + K_Ab_Meta_on * (max - 3) * Ab_C1_b1_m2 * Meta1_C1_f
                      - K_Ab_Meta_off * Ab_C1_b1_m3
                      + K_Ab_Drug_on  * Ab_C1_m3 * Drug_C1_f
                      - K_Ab_Drug_off * Ab_C1_b1_m3
                      "), 
paste0(""))
...
d/dt(Ab_C1_b2_m2) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b2_m2
                      ...
                      + K_Ab_Meta_on * (max - 3) * Ab_C1_b2_m1 * Meta1_C1_f
                      - K_Ab_Meta_off * Ab_C1_b2_m2
                      + K_Ab_Drug_on  * Ab_C1_b1_m2 * Drug_C1_f
                      - K_Ab_Drug_off * Ab_C1_b2_m2
                      "), 
paste0(""))
...
d/dt(Ab_C1_b3_m1) <- - (CL_Ab / V_C1_Ab) * Ab_C1_b3_m1
                      ...
                      + K_Ab_Meta_on * (max - 3) * Ab_C1_b3 * Meta1_C1_f
                      - K_Ab_Meta_off * Ab_C1_b3_m1
                      + K_Ab_Drug_on  * Ab_C1_b2_m1 * Drug_C1_f
                      - K_Ab_Drug_off * Ab_C1_b3_m1
                      "), 
paste0(""))
  
  Ab_C2_b2KD <- ifelse(max > 2, 
                       paste0(" - K_Ab_Drug_on * Ab_C2_b2 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b3
                              "), 
                       paste0(""))
...
d/dt(Ab_C2_b2) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b2 
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b2 
                  + K_Ab_Drug_on * Ab_C2_b1 * Drug_C2_f
...
paste0(""))
  ...
  Ab_C2_b3KD <- ifelse(max > 3, 
                       paste0(" - K_Ab_Drug_on * Ab_C2_b3 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b4
                              "), 
                       paste0(""))
...
d/dt(Ab_C2_b3) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b3 
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b3 
                  + K_Ab_Drug_on  * Ab_C2_b2 * Drug_C2_f
...
paste0(""))
  ...
  Drug_C1_fKD <- ifelse(max >= 2, 
                        paste0("K_Ab_Drug_on  * Ab_C1_b", 1:(max-1), " / V_C1_Drug * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b", 2:max, " / V_C1_Drug
                                  - K_Ab_Drug_on  * Ab_C1_m", 1:(max-1), " / V_C1_Drug * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b1_m", 1:(max-1), " / V_C1_Drug", collapse=" - "), 
                        paste0("0"))
  Drug_C1_fKD2 <- ifelse(max >= 3, 
                         paste0("K_Ab_Drug_on  * Ab_C1_b1_m1 / V_C1_Drug * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b2_m1 / V_C1_Drug"), 
                         paste0("0"))
  Drug_C1_fKD3 <- ifelse(max == 4, 
                         paste0("K_Ab_Drug_on  * Ab_C1_b1_m2 / V_C1_Drug * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b2_m2 / V_C1_Drug
                               - K_Ab_Drug_on  * Ab_C1_b2_m1 / V_C1_Drug * Drug_C1_f + K_Ab_Drug_off * Ab_C1_b3_m1 / V_C1_Drug"), 
                         paste0("0"))
  ...
  Ab_C2_m2KD <- ifelse(max > 2, 
                       paste0(" - K_Ab_Drug_on  * Ab_C2_m2 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b1_m2
                              "), 
                       paste0(""))
...
paste0(""))
  ...
  Ab_C2_m3KD <- ifelse(max > 3, 
                       paste0(" - K_Ab_Drug_on  * Ab_C2_m3 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b1_m3
                              "), 
                       paste0(""))
...
paste0(""))
  ...
  Ab_C2_b1_m1KD <- ifelse(max > 2, 
                          paste0(" - K_Ab_Drug_on  * Ab_C2_b1_m1 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b2_m1
                              "), 
                          paste0(""))
...
d/dt(Ab_C2_b1_m1) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b1_m1 
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b1_m1 
                  + K_Ab_Drug_on  * Ab_C2_m1 * Drug_C2_f
...
paste0(""))
  ...
  Ab_C2_b1_m2KD <- ifelse(max > 3, 
                          paste0(" - K_Ab_Drug_on  * Ab_C2_b1_m2 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b2_m2
                              "), 
                          paste0(""))
...
d/dt(Ab_C2_b1_m2) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b1_m2 
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b1_m2 
                  + K_Ab_Drug_on  * Ab_C2_m2 * Drug_C2_f
...
paste0(""))
  ...
  Ab_C2_b2_m1KD <- ifelse(max > 3, 
                          paste0(" - K_Ab_Drug_on * Ab_C2_b2_m1 * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b3_m1
                              "), 
                          paste0(""))
...
d/dt(Ab_C2_b2_m1) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b2_m1
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b2_m1 
                  + K_Ab_Drug_on  * Ab_C2_b1_m1 * Drug_C2_f
...
d/dt(Ab_C2_b1_m3) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b1_m3 
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b1_m3 
                  + K_Ab_Drug_on * Ab_C2_m3 * Drug_C2_f
...
d/dt(Ab_C2_b2_m2) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b2_m2
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b2_m2 
                  + K_Ab_Drug_on  * Ab_C2_b1_m2 * Drug_C2_f
...
d/dt(Ab_C2_b3_m1) <- (CLD_Ab / V_C1_Ab) * Ab_C1_b3_m1
                  - (CLD_Ab / V_C2_Ab) * Ab_C2_b3_m1 
                  + K_Ab_Drug_on  * Ab_C2_b2_m1 * Drug_C2_f
                  - K_Ab_Drug_off * Ab_C2_b3_m1
                  "), 
paste0(""))
  
  Drug_C2_fKD <- ifelse(max >= 2, 
                        paste0("K_Ab_Drug_on * Ab_C2_b", 1:(max-1), " / V_C2_Drug * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b", 2:max, " / V_C2_Drug
                                  - K_Ab_Drug_on * Ab_C2_m", 1:(max-1), " / V_C2_Drug * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b1_m", 1:(max-1), " / V_C2_Drug", collapse=" - "), 
                        paste0("0"))
  Drug_C2_fKD2 <- ifelse(max >= 3, 
                         paste0("K_Ab_Drug_on * Ab_C2_b1_m1 / V_C2_Drug * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b2_m1 / V_C2_Drug"), 
                         paste0("0"))
  Drug_C2_fKD3 <- ifelse(max == 4, 
                         paste0("K_Ab_Drug_on  * Ab_C2_b1_m2 / V_C2_Drug * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b2_m2 / V_C2_Drug
                               - K_Ab_Drug_on  * Ab_C2_b2_m1 / V_C2_Drug * Drug_C2_f + K_Ab_Drug_off * Ab_C2_b3_m1 / V_C2_Drug"), 
                         paste0("0"))
  ...
  Ab_ex_b1KD <- ifelse(max >= 2, 
                       paste0(" - K_Ab_Drug_on  * Ab_ex_b1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b2 / E_Ab
                                - K_Ab_Meta_on  * Ab_ex_b1 / E_Ab * Meta1_ex_f / (E_Meta * V_tumor) + K_Ab_Meta_off * Ab_ex_b1_m1 / E_Ab
                              "), 
                       paste0(""))
  
  Ab_ex_b2KD <- ifelse(max > 2, 
                       paste0(" - K_Ab_Drug_on  * Ab_ex_b2 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b3 / E_Ab
...
d/dt(Ab_ex_b2) <- (Ab_C1_b2 / V_C1_Ab - Ab_ex_b2 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                  ...
                  + K_Ab_Drug_on * Ab_ex_b1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor)
                  - K_Ab_Drug_off * Ab_ex_b2 / E_Ab
                  ", Ab_ex_b2KD), 
paste0(""))
  
  Ab_ex_b3KD <- ifelse(max > 3, 
                       paste0(" - K_Ab_Drug_on * Ab_ex_b3 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b4 / E_Ab
...
d/dt(Ab_ex_b3) <- (Ab_C1_b3 / V_C1_Ab - Ab_ex_b3 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                  ...
                  + K_Ab_Drug_on  * Ab_ex_b2 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) 
...
paste0(""))
  ...
  Ab_ex_m1KD <- ifelse(max > 1, 
                       paste0(" - K_Ab_Drug_on  * Ab_ex_m1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b1_m1 / E_Ab
                                - K_Ab_Meta_on * (max - 1) * Ab_ex_m1 / E_Ab * Meta1_ex_f / (E_Meta * V_tumor) + K_Ab_Meta_off * Ab_ex_m2 / E_Ab
                              "), 
                       paste0(""))
  
  Ab_ex_m2KD <- ifelse(max > 2, 
                       paste0(" - K_Ab_Drug_on * Ab_ex_m2 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b1_m2 / E_Ab
...
paste0(""))
  ...
  Ab_ex_m3KD <- ifelse(max > 3, 
                       paste0(" - K_Ab_Drug_on * Ab_ex_m3 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b1_m3 / E_Ab
...
paste0(""))
  ...
  Ab_ex_b1_m1KD <- ifelse(max > 2, 
                          paste0(" - K_Ab_Drug_on  * Ab_ex_b1_m1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b2_m1 / E_Ab
...
d/dt(Ab_ex_b1_m1) <- (Ab_C1_b1_m1 / V_C1_Ab - Ab_ex_b1_m1 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                    ...
                    + K_Ab_Drug_on  * Ab_ex_m1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor)
...
paste0(""))
  ...
  Ab_ex_b1_m2KD <- ifelse(max > 3, 
                          paste0(" - K_Ab_Drug_on  * Ab_ex_b1_m2 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b2_m2 / E_Ab
...
d/dt(Ab_ex_b1_m2) <- (Ab_C1_b1_m2 / V_C1_Ab - Ab_ex_b1_m2 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                    ...
                    + K_Ab_Drug_on  * Ab_ex_m2 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) 
...
paste0(""))
  ...
  Ab_ex_b2_m1KD <- ifelse(max > 3, 
                          paste0(" - K_Ab_Drug_on  * Ab_ex_b2_m1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_ex_b3_m1 / E_Ab
...
d/dt(Ab_ex_b2_m1) <- (Ab_C1_b2_m1 / V_C1_Ab - Ab_ex_b2_m1 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                    ...
                    + K_Ab_Drug_on  * Ab_ex_b1_m1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor)
...
d/dt(Ab_ex_b1_m3) <- (Ab_C1_b1_m3 / V_C1_Ab - Ab_ex_b1_m3 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                    ...
                    + K_Ab_Drug_on  * Ab_ex_m3 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) 
...
d/dt(Ab_ex_b2_m2) <- (Ab_C1_b2_m2 / V_C1_Ab - Ab_ex_b2_m2 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                    ...
                    + K_Ab_Drug_on  * Ab_ex_b1_m2 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) 
...
d/dt(Ab_ex_b3_m1) <- (Ab_C1_b3_m1 / V_C1_Ab - Ab_ex_b3_m1 / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                    ...
                    + K_Ab_Drug_on  * Ab_ex_b2_m1 / E_Ab * Drug_ex_f / (E_Drug * V_tumor) 
...
paste0(""))
  ...
  Drug_ex_fKD <- ifelse(max >= 2, 
                        paste0("K_Ab_Drug_on *  Ab_ex_b", 1:(max-1), " / E_Ab * Drug_ex_f / E_Drug + K_Ab_Drug_off * Ab_ex_b", 2:max, " / E_Ab * V_tumor
                                  - K_Ab_Drug_on  * Ab_ex_m", 1:(max-1), " / E_Ab * Drug_ex_f / E_Drug + K_Ab_Drug_off * Ab_ex_b1_m", 1:(max-1), " / E_Ab * V_tumor
                                  - K_Ab_Drug_on  * Ab_cell_b", 1:(max-1), "_b_ag * NC_Tumor * Drug_ex_f / (E_Drug * V_tumor) * SF + K_Ab_Drug_off * Ab_cell_b", 2:max, "_b_ag * NC_Tumor * SF
                                  - K_Ab_Drug_on  * Ab_cell_m", 1:(max-1), "_b_ag * NC_Tumor * Drug_ex_f / (E_Drug * V_tumor) * SF + K_Ab_Drug_off * Ab_cell_b1_m", 1:(max-1), "_b_ag * NC_Tumor * SF", collapse=" - "), 
                        paste0("0"))
  Drug_ex_fKD2 <- ifelse(max >= 3, 
                         paste0("K_Ab_Drug_on  * Ab_ex_b1_m1 / E_Ab * Drug_ex_f / E_Drug + K_Ab_Drug_off * Ab_ex_b2_m1 / E_Ab * V_tumor
                                - K_Ab_Drug_on *  Ab_cell_b1_m1_b_ag * NC_Tumor * Drug_ex_f / (E_Drug * V_tumor) * SF + K_Ab_Drug_off * Ab_cell_b2_m1_b_ag * NC_Tumor * SF"), 
                         paste0("0"))
  Drug_ex_fKD3 <- ifelse(max == 4, 
                         paste0("K_Ab_Drug_on  * Ab_ex_b1_m2 / E_Ab * Drug_ex_f / E_Drug + K_Ab_Drug_off * Ab_ex_b2_m2 / E_Ab * V_tumor
                               - K_Ab_Drug_on  * Ab_ex_b2_m1 / E_Ab * Drug_ex_f / E_Drug + K_Ab_Drug_off * Ab_ex_b3_m1 / E_Ab * V_tumor
                               - K_Ab_Drug_on  * Ab_cell_b1_m2_b_ag * NC_Tumor * Drug_ex_f / (E_Drug * V_tumor) * SF + K_Ab_Drug_off * Ab_cell_b2_m2_b_ag * NC_Tumor * SF
                               - K_Ab_Drug_on  * Ab_cell_b2_m1_b_ag * NC_Tumor * Drug_ex_f / (E_Drug * V_tumor) * SF + K_Ab_Drug_off * Ab_cell_b3_m1_b_ag * NC_Tumor * SF"), 
                         paste0("0"))
  ...
  Ab_cell_b1KD <- ifelse(max >= 2, 
                         paste0(" - K_Ab_Drug_on  * Ab_cell_b1_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b2_b_ag
  ...
  Ab_cell_b2KD <- ifelse(max > 2, 
                         paste0(" - K_Ab_Drug_on  * Ab_cell_b2_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b3_b_ag
...
d/dt(Ab_cell_b2_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b2 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                         ...
                         + K_Ab_Drug_on  * Ab_cell_b1_b_ag * Drug_ex_f / (E_Drug * V_tumor)
                         - K_Ab_Drug_off * Ab_cell_b2_b_ag
                         ", Ab_cell_b2KD), 
paste0(""))
  
  Ab_cell_b3KD <- ifelse(max > 3, 
                         paste0(" - K_Ab_Drug_on  * Ab_cell_b3_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b4_b_ag
...
d/dt(Ab_cell_b3_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b3 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                         ...
                         + K_Ab_Drug_on  * Ab_cell_b2_b_ag * Drug_ex_f / (E_Drug * V_tumor) 
...
paste0(""))
  ...
  Ab_cell_m1KD <- ifelse(max >= 2, 
                         paste0(" - K_Ab_Drug_on  * Ab_cell_m1_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b1_m1_b_ag
                                  - K_Ab_Meta_on * (max - 1) * Ab_cell_m1_b_ag * Meta1_ex_f / (E_Meta * V_tumor) + K_Ab_Meta_off * Ab_cell_m2_b_ag
                                "), 
                         paste0(""))
  
  Ab_cell_m2KD <- ifelse(max > 2, 
                         paste0(" - K_Ab_Drug_on  * Ab_cell_m2_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b1_m2_b_ag
...
paste0(""))
  ...
  Ab_cell_m3KD <- ifelse(max > 3, 
                         paste0(" - K_Ab_Drug_on * Ab_cell_m3_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b1_m3_b_ag
...
paste0(""))
  ...
  Ab_cell_b1_m1KD <- ifelse(max > 2, 
                            paste0(" - K_Ab_Drug_on  * Ab_cell_b1_m1_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b2_m1_b_ag 
...
d/dt(Ab_cell_b1_m1_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b1_m1 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                          ...
                          + K_Ab_Meta_on * (max - 1) * Ab_cell_b1_b_ag * Meta1_ex_f / (E_Meta * V_tumor)
                          - K_Ab_Meta_off * Ab_cell_b1_m1_b_ag 
                          + K_Ab_Drug_on  * Ab_cell_m1_b_ag * Drug_ex_f / (E_Drug * V_tumor)
...
paste0(""))
  ...
  Ab_cell_b1_m2KD <- ifelse(max > 3, 
                            paste0(" - K_Ab_Drug_on  * Ab_cell_b1_m2_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b2_m2_b_ag 
...
d/dt(Ab_cell_b1_m2_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b1_m2 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                          ...
                          + K_Ab_Drug_on  * Ab_cell_m2_b_ag * Drug_ex_f / (E_Drug * V_tumor)
...
paste0(""))
  ...
  Ab_cell_b2_m1KD <- ifelse(max > 3, 
                            paste0(" - K_Ab_Drug_on * Ab_cell_b2_m1_b_ag * Drug_ex_f / (E_Drug * V_tumor) + K_Ab_Drug_off * Ab_cell_b3_m1_b_ag 
...
d/dt(Ab_cell_b2_m1_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b2_m1 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                          ...
                          + K_Ab_Meta_on * (max - 2) * Ab_cell_b2_b_ag * Meta1_ex_f / (E_Meta * V_tumor)
                          - K_Ab_Meta_off * Ab_cell_b2_m1_b_ag 
                          + K_Ab_Drug_on  * Ab_cell_b1_m1_b_ag * Drug_ex_f / (E_Drug * V_tumor)
...
d/dt(Ab_cell_b1_m3_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b1_m3 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                          ...
                          + K_Ab_Drug_on  * Ab_cell_m3_b_ag * Drug_ex_f / (E_Drug * V_tumor)
...
d/dt(Ab_cell_b2_m2_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b2_m2 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                          ...
                          + K_Ab_Drug_on  * Ab_cell_b1_m2_b_ag * Drug_ex_f / (E_Drug * V_tumor)
...
d/dt(Ab_cell_b3_m1_b_ag) <- K_Ab_cell_ag_on * Ab_ex_b3_m1 / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                          ...
                          + K_Ab_Meta_on * (max - 3) * Ab_cell_b3_b_ag * Meta1_ex_f / (E_Meta * V_tumor)
                          - K_Ab_Meta_off * Ab_cell_b3_m1_b_ag 
                          + K_Ab_Drug_on  * Ab_cell_b2_m1_b_ag * Drug_ex_f / (E_Drug * V_tumor)
...
paste0(""))
 ...
 # Modeling assignemnts -----------------------------------
  ...
  d/dt(Ab_C1_f) <- - (CL_Ab / V_C1_Ab) * Ab_C1_f 
                    ...
                    - K_Ab_Drug_on  * Ab_C1_f * Drug_C1_f
 ...
 {{Ab_C1_b3_m1}}
  ...
  d/dt(Drug_C1_f) <- - CL_Drug / V_C1_Drug * Drug_C1_f 
                     ...
                     - K_Ab_Drug_on * Ab_C1_f / V_C1_Drug * Drug_C1_f
  ...
  d/dt(Ab_C2_f) <- CLD_Ab / V_C1_Ab * Ab_C1_f 
                  - CLD_Ab / V_C2_Ab * Ab_C2_f
                   - K_Ab_Drug_on  * Ab_C2_f * Drug_C2_f
 ...
 {{Ab_C2_b3_m1}}
  ...
  d/dt(Drug_C2_f) <- CLD_Drug / V_C2_Drug * Drug_C1_f
                    ...
                    - K_Ab_Drug_on  * Ab_C2_f / V_C2_Drug * Drug_C2_f
  ...
  d/dt(Ab_ex_f) <- (Ab_C1_f / V_C1_Ab - Ab_ex_f / E_Ab) * (2 * P_Ab * R_Cap / R_Krogh^2 + 6 * D_Ab / R_Tumor^2)
                    ...
                    - K_Ab_Drug_on  * Ab_ex_f / E_Ab * Drug_ex_f / (E_Drug * V_tumor)
 ...
 {{Ab_ex_b3_m1}}
  ...
  d/dt(Drug_ex_f) <- (Drug_C1_f - Drug_ex_f / (V_tumor * E_Drug)) * V_tumor * (2 * P_Drug * R_Cap / R_Krogh^2 + 6 * D_Drug / R_Tumor^2) 
                    ...
                    - K_Ab_Drug_on  * Ab_ex_f / E_Ab * Drug_ex_f / E_Drug
                    + K_Ab_Drug_off * Ab_ex_b1 / E_Ab * V_tumor
                    - K_Ab_Drug_on  * Ab_cell_f_b_ag * NC_Tumor * Drug_ex_f / (E_Drug * V_tumor) * SF
  ...
  d/dt(Ab_cell_f_b_ag) <- K_Ab_cell_ag_on * Ab_ex_f / E_Ab * (Ag_cell_t - Ab_cell_f_b_ag - Ab_cell_b1_b_ag - Ab_cell_m1_b_ag 
                        - ({{Ab_ex_f}}) - ({{Ab_ex_f_combi1}}) - ({{Ab_ex_f_combi2}}) - {{Ab_ex_f_combi3}}) 
                          ...
                          - K_Ab_Drug_on  * Ab_cell_f_b_ag * Drug_ex_f / (E_Drug * V_tumor)
